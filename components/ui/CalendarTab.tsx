    ...
    <ScrollView className="flex-1 px-4" showsVerticalScrollIndicator={false}>
      ...
      <View className="bg-[#1C1C1E] p-4 rounded-2xl border border-gray-800 items-center mb-6">
         <View className="bg-gray-800 px-3 py-1 rounded-full mb-2">
            <Text className="text-gray-400 text-xs font-medium">Current Streak</Text>
         </View>
         <View className="flex-row items-end">
            <Text className="text-[#8B5CF6] text-3xl font-bold">{habit.currentStreak || 0}</Text>
            <Text className="text-gray-500 text-base mb-1 ml-1 font-medium">DAYS</Text>
         </View>
      </View>
